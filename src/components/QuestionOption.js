...
class QuestionOption extends React.Component {
    render() {
        ...
        return (
        <Button className={classes.optionCard} style={{background:backgroundColor, marginLeft: leftMargin}} onClick={() => handleSubmitAnswer(isFirstOption ? 'optionOne' : 'optionTwo')}>
                {
